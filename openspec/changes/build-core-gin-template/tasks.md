...
- [ ] 5.1 为配置、JWT、Hash、响应和小时日志切割编写单元测试。
- [ ] 5.2 为 Repo/Service 及登录、鉴权用户信息链路编写可重复执行的测试。
- [ ] 5.3 执行格式化、静态检查和测试；修复所有回归。
- [ ] 5.4 更新 README，说明配置、MySQL/Redis 前置条件、启动方式、API 示例与安全配置要求。
